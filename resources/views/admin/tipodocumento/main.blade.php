        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Gestión de Tipos de Documentos</h3>
                  ...
                  <div class="card-body">
                    <div class="col-md-12">
                        <div class="form-group">
                          <x-adminlte-button @click="nuevo()" id="btnNuevo" class="bg-gradient btn-sm" type="button" label="Nuevo Tipo de Documento" theme="primary" icon="fas fa-plus-square"/>
                        </div>
                      </div>
                  </div>
                </form>
            ...
            <div class="card card-primary">
                ...
                <form>
                  <div class="card-body">
                        ...
                        <table class="table table-bordered table-sm">
                            <thead>
                                <tr>
                                    ...
                                    <th class="titles-table" style="width: 85%">Nombre</th>
                    ...
                    <div v-else>
                        <h6>No existen registros de Tipos de Documentos</h6>
                    </div>
                  </div>
                </form>
              </div>
