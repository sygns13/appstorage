<div class="col-md-12" v-if="divFormularioDetalles && !divFormularioRev">
           ...
           {{--  <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-12">
                ...
                <embed v-bind:src="'{{ asset('/repositorio/')}}'+'/'+fillobject.ubicacion_electronica+'/'+fillobject.nombre_electronico"  width="100%" height="800px" />
                ...
                frameborder="0" style="overflow:hidden;height:600px;width:100%" height="600px;" width="100%"></iframe> --}}
