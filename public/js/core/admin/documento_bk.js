...
createApp({
    data() {
        return {
            ...
            labelBtnSave: 'Registrar Borrador',
    ...
    mounted: function() {
        this.fillobject.area_id = id_area;
    },
    computed: {
        isActived: function() {
    ...
    methods: {
        ...
        nuevo:function () {
            this.cancelForm();
            this.labelBtnSave = 'Registrar Borrador';
        ...
        cancelForm: function () {
            this.fillobject = {
                ...
                'area_aprobacion_id': '0',
                'version_actual': '1',
                'ubicacion_electronica': 'borrador',
                'nombre_electronico': '',
                'revision': '1',
                'activo': '1',
                'obs_elaboracion': '',
        ...
        edit:function (dato) {
            ...
            this.labelBtnSave = 'Modificar Borrador';
