...
createApp({
    data() {
        return {
            tituloHeader: "Repositorio de Documentos de la CSJAN",
            subtituloHeader: "Visualización de Documentos",
            subtitulo2Header: "",
    ...
    methods: {
        ...
        getDatos: function(page) {
            var url = 'getrepositorio?page=' + page + '&area_id=' + this.area_id + '&tipo_documento_id=' + this.tipo_documento_id + '&busca=' + this.buscar;
