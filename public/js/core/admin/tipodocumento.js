...
createApp({
    data() {
        return {
            ...
            subtituloHeader: "Gestión de Tipos de Documentos",
            subtitulo2Header: "",
    ...
    methods: {
        ...
        getDatos: function(page) {
            var url = 'retipo-documentos?page=' + page + '&busca=' + this.buscar;
        ...
        confirmRegistrar:function () {
            swal.fire({
                title: '¿Estás seguro?',
                text: "Desea Confirmar el Registro del Tipo de Documento",
                icon: 'info',
        ...
        confirmActualizar:function () {
            swal.fire({
                title: '¿Estás seguro?',
                text: "Desea Confirmar la Modificación del Tipo de Documento",
                icon: 'info',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
        ...
        update: function () {
            ...
            var url="retipo-documentos/"+this.fillobject.id;
        ...
        borrar:function (dato) {
            swal.fire({
                title: '¿Estás seguro?',
                text: "Desea Eliminar el registro del Tipo de Documento",
                icon: 'info',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
        ...
        delete:function (dato) {
            var url = 'retipo-documentos/'+dato.id;
